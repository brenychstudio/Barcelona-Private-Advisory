...
const advisoryByListingId: Record<string, ListingAdvisory> = {
  ...
  "l-05": {
    ...
    advisoryEs: {
      bestFor: "Familias en relocalización que priorizan rutinas calmadas, colegios y confort a largo plazo.",
  ...
  "l-07": {
    ...
    advisoryEs: {
      ...
      signal: "Carácter preservado, detalle cálido y atmósfera de calma casi museística.",
      ...
      riskNote: "Revisar antigüedad del edificio, permisos, ventanas de ruido y obligaciones de conservación.",
  ...
  "l-09": {
    ...
    advisoryEs: {
      ...
      signal: "Estilo neutro, acabados durables y bajo riesgo estético.",
      ...
      riskNote: "Revisar supuestos de rentabilidad, historial de mantenimiento y diferenciación de reventa.",
